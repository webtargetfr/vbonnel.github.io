...
parcelRequire = function (e, r, n, t) {
    ...
    TvQq: [function (require, module, exports) {
        ...
        var e = Object.assign || function (e) {
            ...
            , d = function (e) {
                ...
                return o.classList.add("medium-zoom-overlay"),
                    o.style.background = e,
                    o
            }
            , m = function (e) {
            ...
            , a = function (o, t) {
                ...
                if ("function" == typeof window.CustomEvent)
                    return new CustomEvent(o, n);
                var i = document.createEvent("CustomEvent");
                return i.initCustomEvent(o, n.bubbles, n.cancelable, n.detail),
                    i
            }
            ...
            , l = function o(t) {
                        ...
                        var o = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).target
                            , t = function () {
                                var o = Math.min
                                    ...
                                    , d = void 0;
                                if (y.container)
                                    if (y.container instanceof Object)
                                        r = (t = e({}, t, y.container)).width - t.left - t.right - 2 * y.margin,
                                            d = t.height - t.top - t.bottom - 2 * y.margin;
                                    else {
                                ...
                                r = r || t.width - 2 * y.margin,
                                    d = d || t.height - 2 * y.margin;
                                ...
                                b.zoomed.style.transform = C,
                                    b.zoomedHd && (b.zoomedHd.style.transform = C)
                            };
                        return new c(function (e) {
                            if (o && -1 === g.indexOf(o))
                                ...
                                if (b.original.dispatchEvent(a("medium-zoom:open", {
                                    ...
                                    z = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0,
                                    h = !0,
                                    b.zoomed = m(b.original),
                                    document.body.appendChild(E),
                                    y.template) {
                                    var r = n(y.template) ? y.template : document.querySelector(y.template);
                                    b.template = document.createElement("div"),
                                        b.template.appendChild(r.content.cloneNode(!0)),
                                        document.body.appendChild(b.template)
                                }
                                if (document.body.appendChild(b.zoomed),
                                    window.requestAnimationFrame(function () {
                                        document.body.classList.add("medium-zoom--opened")
                                    }),
                                    b.original.classList.add("medium-zoom-image--hidden"),
                                    b.zoomed.classList.add("medium-zoom-image--opened"),
                                    b.zoomed.addEventListener("click", f),
                                    b.zoomed.addEventListener("transitionend", function o() {
                                        h = !1,
                                            b.zoomed.removeEventListener("transitionend", o),
                                            b.original.dispatchEvent(a("medium-zoom:opened", {
                                                detail: {
                                                    zoom: w
                                                }
                                            })),
                                    ...
                                    var d = setInterval(function () {
                                        b.zoomedHd.complete && (clearInterval(d),
                                            b.zoomedHd.classList.add("medium-zoom-image--opened"),
                                            b.zoomedHd.addEventListener("click", f),
                                    ...
                                    var c = b.zoomedHd.addEventListener("load", function () {
                                        b.zoomedHd.removeEventListener("load", c),
                                            b.zoomedHd.classList.add("medium-zoom-image--opened"),
                                            b.zoomedHd.addEventListener("click", f),
                                            document.body.appendChild(b.zoomedHd),
                                            t()
                    ...
                    , f = function () {
                        return new c(function (e) {
                            !h && b.original ? (h = !0,
                                ...
                                b.original.dispatchEvent(a("medium-zoom:close", {
                                    detail: {
                                        zoom: w
                                    }
                                })),
                                b.zoomed.addEventListener("transitionend", function o() {
                                    b.original.classList.remove("medium-zoom-image--hidden"),
                                        ...
                                        h = !1,
                                        b.zoomed.removeEventListener("transitionend", o),
                                        b.original.dispatchEvent(a("medium-zoom:closed", {
                                            detail: {
                                                zoom: w
                                            }
                                        })),
                ...
                "[object Object]" === Object.prototype.toString.call(t) ? y = t : (t || "string" == typeof t) && u(t),
                    y = e({
                        margin: 0,
                        background: "#fff",
                        scrollOffset: 40,
                ...
                var w = {
                    ...
                    update: function () {
                        var o = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}
                            , t = o;
                        if (o.background && (E.style.background = o.background),
                            o.container && o.container instanceof Object && (t.container = e({}, y.container, o.container)),
                            o.template) {
                    ...
                    detach: function () {
                        ...
                        return n.forEach(function (e) {
                            e.classList.remove("medium-zoom-image"),
                                e.dispatchEvent(a("medium-zoom:detach", {
                                    detail: {
                                        zoom: w
                                    }
                                }))
        ...
        function u(e, o) {
            ...
            if (e && "undefined" != typeof document) {
                ...
                i.type = "text/css",
                    "top" === t && n.firstChild ? n.insertBefore(i, n.firstChild) : n.appendChild(i),
    ...
    H99C: [function (require, module, exports) {
        ...
        var o = (0,
            e.default)("#zoom-default")
            , a = (0,
                e.default)("#zoom-margin", {
                    margin: 14
                })
            , n = (0,
                e.default)("#zoom-background", {
                    background: "#212530"
                })
            , r = (0,
                e.default)("#zoom-scrollOffset", {
                    scrollOffset: 0,
                    background: "rgba(25, 18, 25, .9)"
                })
            , c = (0,
                e.default)("#zoom-trigger")
            , u = document.querySelector("#button-trigger");
        u.addEventListener("click", function () {
            return c.open()
        });
        var i = (0,
            e.default)("#zoom-detach");
